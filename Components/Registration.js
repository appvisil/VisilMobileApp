...
class Registration extends React.Component {
    ...
    getCountryData = async () => {
        ...
        await firestore().collection('CountryList').onSnapshot((snapshot) => {
            ...
            snapshot.docs.forEach(function (doc) {
                ...
                CountryList.push(doc.data().CountryCode);
            });
    ...
    handlePhone = (text) => {
        this.setState({ userId: this.state.countryCode+text })
        this.setState({ mobile: this.state.countryCode+text })
        console.log(this.state);
    }

    GoToOTP = (email, username) => {
        this.props.navigation.navigate('PasswordReg', this.state)

    }

    GoToRegistrationTypes = () => {
        this.props.navigation.navigate('RegistrationTypes')
    ...
    render() {
        const EmailFeild = <View>
            {/* <Text style={styles.LableHeadings}>Email Address</Text> */}
        ...
        const PhoneNumberFeild = <View style={{ flexDirection: 'row',marginTop:20 }}>
            {/* <Text style={styles.LableHeadings}>Phone</Text> */}
            <View style={{ width: "25%" }}>
                <SelectDropdown
                    ...
                    defaultButtonText={this.state.countryCode}
            ...
            <View>
                ...
                <Popover isVisible={this.state.showPopover} onRequestClose={() => this.setState({ showPopover: false })}>
                    <Text style={{ fontSize: 20, color: "black", margin: 10 }}>Please enter mobile number with county code.</Text>
                </Popover>
            </View>
        </View>;
        ...
        const EmailTab = <View style={{ flexDirection: 'row' }}>
            ...
            <TouchableOpacity
                ...
                <Text style={styles.SelectedTabBtn}> Email </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
                ...
                <Text style={styles.TabBtn}> Phone </Text>
            </TouchableOpacity>
        ...
        const PhoneTab = <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity
                ...
                <Text style={styles.TabBtn}> Email </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
                ...
                <Text style={styles.SelectedTabBtn}> Phone </Text>
            </TouchableOpacity>
        </View>;
        return (
            <View>
                ...
                <View style={styles.container}>
                    ...
                    <View>
                        <Text style={styles.LableHeadings}>Full Name</Text>
                        <TextInput style={styles.input}
                            underlineColorAndroid="transparent"
                    ...
                    <View>
                        <Text style={styles.LableHeadings}>DOB</Text>
                        <TextInput style={styles.input}
                    ...
                    <View>
                        <Text style={styles.LableHeadings}>Gender</Text>
                        <RadioButton.Group onValueChange={this.handleGender} value={this.state.gender}>
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'row' }}><RadioButton value="Male" color="#4d089e" /><TouchableOpacity
                                >
                                    <Text style={styles.RadioText}>Male</Text>
                                </TouchableOpacity></View>
                                <View style={{ flexDirection: 'row' }}><RadioButton value="Female" color="#4d089e" /><TouchableOpacity>
                                    <Text style={styles.RadioText}>Female</Text>
                                </TouchableOpacity></View>

                                <View style={{ flexDirection: 'row' }}><RadioButton value="None" color="#4d089e" /><TouchableOpacity>
                                    <Text style={styles.RadioText}>Does not wish to specify</Text>
                                </TouchableOpacity></View>
                            </View>
                        </RadioButton.Group>
                    </View>
                    <View style={{ flexDirection: 'row',justifyContent: 'center' }}>
                        ...
                        <TouchableOpacity
                            //style={styles.NextButton}
                            onPress={
                                () => this.GoToOTP(this.state.email, this.state.username)
                            }>
