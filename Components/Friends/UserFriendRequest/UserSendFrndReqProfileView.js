...
class UserSendFrndReqProfileView extends React.Component {
  UserData = {};
              ...
              <View className="ProfileTopContent" style={styles.ProfileTopContent}>
                ...
                <View style={{ width: "100%", alignItems: 'center', }}>
                  <View style={{ flexDirection: "row", alignItems: 'center', }}>
                    <View style={{ margin: 20, backgroundColor: '#5596e6', borderRadius: 15, width: 400, alignItems: 'center', }}>
                      <TouchableOpacity >
                        <Text style={{ color: "white", margin: 15, fontSize: 22, fontWeight: "bold", }}>Cancel Request</Text>
                      </TouchableOpacity>
                    </View>
...
export default UserSendFrndReqProfileView;
