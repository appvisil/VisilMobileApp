...
class UserFriendsProfileView extends React.Component {
                    ...
                    <View className="U" style={styles.U}>
                            ...
                            <View className="ProfileTopContent" style={styles.ProfileTopContent}>
                                <View style={{ flexDirection: "row", }}>
                                    ...
                                    <View style={{ width: "70%", alignItems: 'center', }}>
                                        ...
                                        <Text style={{ fontWeight: "bold", color: "black", fontSize: 30, fontStyle: 'normal', margin: 10 }}>Ramana</Text>
                                ...
                                <View style={{ width: "100%", alignItems: 'center', }}>
                                    <View style={{ flexDirection: "row", alignItems: 'center', }}>
                                        <View style={{ margin: 10, backgroundColor: '#5596e6', borderRadius: 15, width: 180, alignItems: 'center', }}>
                                            <TouchableOpacity >
                                                <View style={{ color: "#1e1f20", fontSize: 20, flexDirection: "row", margin: 15 }}>
                                                    {/* <Text>
                                                        <FontAwesome5 name="user-friends" size={30} style={{ color: "white", }} />
                                                    </Text> */}
                      ...
                      <TouchableOpacity >
                        <Text style={{ color: "white", margin: 15, fontSize: 22, fontWeight: "bold", }}>Delete</Text>
                                        ...
                                        <View style={{ margin: 10, backgroundColor: '#ebecec', borderRadius: 15, width: 180, alignItems: 'center', }}>
                                            <TouchableOpacity >
                                                <View style={{ color: "#1e1f20", fontSize: 20, flexDirection: "row", margin: 15 }}>
                                                    <Text>
...
export default UserFriendsProfileView;
