...
class UserSuggFrndsListProfileView extends React.Component {
  userObj = {};

  constructor(props) {
    super(props);
    this.userObj = props.route.params;
    console.log("profile" + this.userObj);
    this.state = {
      email: '',
      password: '',
      isloading: true,
  ...
  render() {
    // console.log("hai"+this.props.route.params.UserName);
    this.userObj = this.props.route.params;
    return (
      <ScrollView>
        <View>
              ...
              <View className="ProfileTopContent" style={styles.ProfileTopContent}>
                ...
                <View style={{ width: "100%", alignItems: 'center', }}>
                  <View style={{ flexDirection: "row", alignItems: 'center', }}>
                    <View style={{ margin: 20, backgroundColor: '#5596e6', borderRadius: 15, width: 150, alignItems: 'center', }}>
                      <TouchableOpacity >
                        <Text style={{ color: "white", margin: 15, fontSize: 22, fontWeight: "bold", }}>Follow</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={{ margin: 20, backgroundColor: '#5596e6', borderRadius: 15, width: 150, alignItems: 'center', }}>
                      <TouchableOpacity >
                        <Text style={{ color: "white", margin: 15, fontSize: 22, fontWeight: "bold", }}>Cancel</Text>
                      </TouchableOpacity>
                    </View>
...
export default UserSuggFrndsListProfileView;
